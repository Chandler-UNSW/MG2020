...
def main():
    ...
    # Change the following lines to change the image with out parsing in input (ie default image)
    parser.add_argument("--image", default= "people1.jpeg", help="path to video file. If empty, camera's stream will be used")
    # parser.add_argument("--image", default= "img.jpeg", help="path to video file. If empty, camera's stream will be used")
    # parser.add_argument("--image", default= "foosball1.jpg", help="path to video file. If empty, camera's stream will be used")
    # ^^ the aspect ratio doesnt work to well for this - need to comment out line 134 and uncomment line 135)
    ...
    frameR = ResizeWithAspectRatio(frame, width=1280)  # Resize by width
    # frameR = ResizeWithAspectRatio(frame, height=1280)  # Resize by height
    cv2.imshow("frame", frameR)
    cv2.waitKey(0)  # To exit the image press any key
